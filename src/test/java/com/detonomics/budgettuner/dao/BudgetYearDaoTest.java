...
class BudgetYearDaoTest {
        ...
        @BeforeEach
        void setUp() {
                dbPath = tempDir.resolve("test_budget_year.db").toAbsolutePath().toString();
        ...
        void testLoadBudgetYearsList() {
                ...
                dbManager.executeUpdate(insertBudget);
        ...
        void testLoadBudgetIDByYear() {
                String createBudgets = "CREATE TABLE IF NOT EXISTS Budgets (" +
                                ...
                                ")";
                dbManager.executeUpdate(createBudgets);
                dbManager.executeUpdate("INSERT INTO Budgets (budget_year) VALUES (2030)");
