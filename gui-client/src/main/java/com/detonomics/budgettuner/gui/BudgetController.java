...
import com.detonomics.budgettuner.backend.mainapplicationfeatures.DatabaseManager;
...
public class BudgetController {
    ...
    private void loadBudgetsFromDatabase() {
        ...
        try {
            ...
            List<Map<String, Object>> results = dbManager.executeQuery(DB_PATH, sql);
    ...
    private void setupSearchField() {
        ...
        searchField.setOnMouseClicked(e -> searchField.positionCaret(Math.max(searchField.getCaretPosition(), SEARCH_PREFIX.length())));
    ...
    protected void onOpenBudgetClick(ActionEvent event) throws IOException {
        ...
        BudgetManager budgetManager = new BudgetManager(DB_PATH);
        BudgetYear budget = budgetManager.loadBudgetYearByYear(year);
