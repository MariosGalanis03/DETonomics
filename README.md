...
- Επιλογή αποθήκευσης αλλαγών σε έσοδα και έξοδα σε νέο προυπολογισμό στην SQLite βάση (με επιλογή ονόματος).
- Γραφήματα με Διαχρονική Εξέλιξη Προϋπολγισμού.
- Γραφήματα με καταμερισμό δαπανών και εσόδων στα διάφορα κρατικά σώματα και λειτουργίες αντίστοιχα.
- Ολοκλήρωση παραθύρου Γραφικής Διεπαφής.
